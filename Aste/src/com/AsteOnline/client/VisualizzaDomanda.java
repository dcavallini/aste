...
public class VisualizzaDomanda extends Composite implements HasText {

	public Domanda domanda = new Domanda();

	private static VisualizzaDomandaUiBinder uiBinder = GWT.create(VisualizzaDomandaUiBinder.class);

	private final GreetingServiceAsync greetingService=GWT.create(GreetingService.class);

	interface VisualizzaDomandaUiBinder extends UiBinder<Widget, VisualizzaDomanda> {
	}

	public VisualizzaDomanda() {
		initWidget(uiBinder.createAndBindUi(this));

//		greetingService.viewDomanda(new AsyncCallback<ArrayList<Domanda>>() {
//
//			@Override
